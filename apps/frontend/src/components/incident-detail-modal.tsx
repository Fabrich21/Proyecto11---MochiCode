...
import { X, Check, Archive, Clock, Users, FileText, AlertTriangle, Clipboard, Edit2, Loader2 } from 'lucide-react';
import { Incident, IncidenteEstado, getIncidentStatusBadgeClassName, getIncidentStatusLabel, normalizeIncidentStatus, PostMortem } from './incident-types';
...
interface Props {
  ...
  onIncidentUpdated?: (i: Incident) => void;
  onPostMortemCreated?: (incidentId: string, postMortemId: string) => void;
}
...
export function IncidentDetailModal({ 
  ...
  const { createPostMortem, getPostMortem } = usePostMortem(); 
